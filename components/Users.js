...
const Users = ({ userData, setSelectedChatroom }) => {
  ...
  return (
    <div className="h-screen mt-4 mb-20 overflow-auto shadow-lg">
      <div className="flex flex-col justify-between p-4 space-y-4 lg:flex-row lg:space-y-0">
        <button
      ...
      <div>
        ...
        {activeTab === "users" && (
          <>
            <h1 className="px-4 mt-4 text-base font-semibold">Users</h1>
            {loading2 && (
              <div className="flex items-center justify-center h-full">
                <span className="loading loading-spinner text-primary"></span>
              </div>
